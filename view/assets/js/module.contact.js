var app_contact = function(config) {
...
app_contact.prototype = {
	...
	_routes : function(){
		...
		app.get('#/contact', function () { 
		    ...
		    main._active_menu('main-link-contact');
		    $('.main-link-contact').addClass('active');

		    $body.find('.main-content').hide(); 
	        $body.find('.main-content[container-id="search-contact"]').fadeIn("slow");
...
var app_contact = new app_contact(null);