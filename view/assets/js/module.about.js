...
app_about.prototype = {
	...
	_routes : function(){
		...
		app.get('#/about', function () { 
		    ...
		    main._active_menu('main-link-about');
		    $('.main-link-about').addClass('active');

		    $body.find('.main-content').hide(); 
	        $body.find('.main-content[container-id="search-about"]').fadeIn("slow");
...
var app_about = new app_about(null);